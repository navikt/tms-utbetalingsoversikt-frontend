...
const REDIRECT_URI = {
  ...
  development: window.location.hostname.includes("intern.dev.nav.no")
    ? "https://www.intern.dev.nav.no/utbetalingsoversikt-ny"
    : "https://www.ansatt.dev.nav.no/utbetalingsoversikt-ny",
